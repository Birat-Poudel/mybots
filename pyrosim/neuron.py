    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for synapse in synapses.keys():
            if synapse[1] == self.Get_Name():
                ...
                preValue = neurons[synapse[0]].Get_Value()
                self.Allow_Presynaptic_Neuron_To_Influence_Me(weight, preValue)
        self.Threshold()

    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, preValue):
        newValue = weight*preValue
